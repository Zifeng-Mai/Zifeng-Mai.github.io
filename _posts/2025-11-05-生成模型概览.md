...
1. 令 $f(u)=u\log u$，此时 $\mathcal{D}_f=\mathcal{D}_{KL}$；
2. 令 $f(u)=\frac{1}{2}\left[ u\log u-(u+1)\log\frac{1+u}{2} \right]$，此时 $\mathcal{D}_f=\mathcal{D}_{JS}$；
3. 令 $f(u)=\frac{1}{2}\lvert u-1 \rvert$，此时  $\mathcal{D}_f=\mathcal{D}_{TV}$；
