...
preview:    本文是张颢老师随机过程课程笔记的第六篇。在本文中，我们主要介绍了多元高斯分布的一些基本性质，包括其概率密度函数、特征函数和线性性。根据线性性，我们探讨了边缘分布的高斯性与联合分布的高斯性之间的关系。最后，我们介绍了DDPM模型，这是高斯过程的一个非常典型的应用，它在图像生成等任务中发挥了重要作用。
catalog: true
series: 随机过程
tags:
    - Stochastic Process
